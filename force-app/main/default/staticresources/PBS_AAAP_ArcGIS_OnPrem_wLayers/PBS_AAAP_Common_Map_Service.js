...
console.log('Common Map Service JS file load...');
...
console.log('Common Map Service JS init() function starting...');

console.log('ArcGIS Server from the Apex controller: ' + SF_Label.urlPrefix);

console.log('Token from the PBS_AAAP_OfferBuildingController Apex class:' + SF_Label.gisToken);
    ...
    return new Promise(function (resolve, reject) {
	    ...
	    //Todd Brown commented addProxyRule() out for new GSA OnPrem REST service register token that was 
	    //           generated by the Apex controller constructor method. 
	    //           Also added the 'esri/identity/Credential "require" above for the new registerToken call below
            //           because we are no longer using the Proxy and need to use a token.
            //Utils.addProxyRule({
		...
		IdentityManager.registerToken({
            ...
            // Create new topographical vector map and view instance.
            self.map = new Map({
                basemap: 'topo-vector',
            });
