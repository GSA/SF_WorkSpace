...
//console.log('ArcGIS Utility file load');
...
ArcGIS_v4_19.prototype.moveMarker = function (address, location) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        //console.log('moveMarker, marker returned from createMarker()', marker);
            ...
            this.addressToCoordinates(address)
                .then(
                    function (locations) {
                        ...
                        if (evt) {
                            //never reaches this, no evt is ever passed in as params to this function
...
ArcGIS_v4_19.prototype.search = function (location) {
    //console.log('search function, location passed in is: ' + JSON.stringify(location));
    let doubleClick = false;
    if (location.singleLineAddress && location.singleLineAddress.length > 0) {
        return new Promise(
            function (resolve, reject) {
