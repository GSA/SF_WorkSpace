...
console.log('Todd testing. Common Map Service JS file load...');
...
console.log('Todd testing. Common Map Service JS init() function starting...');

console.log('ArcGIS Server from the Apex controller: ' + SF_Label.urlPrefix);

//console.log('Token from the Apex controller: ');
//console.log($("[id$='gistoken']").val());
console.log('Token from the Apex controller: ' + SF_Label.gisToken);
    ...
    return new Promise(function (resolve, reject) {
        ...
        ], function (esriConfig, Utils, Map, MapView, webMercatorUtils, Locator, Extent, Multipoint, Graphic, GraphicsLayer, Point, PopupTemplate, IdentityManager) {
...
//Todd Brown commented addProxyRule() out to test new REST service. Also added the 'esri/identity/Credential "require" above.
            //Utils.addProxyRule({
            //    urlPrefix: SF_Label.urlPrefix,  
            //    proxyUrl: SF_Label.proxyUrl     
            //});

//Todd Brown trying to register token from Salesforce Apex controller class.

		/* IdentityManager.registerToken({
			server: SF_Label.urlPrefix,
			token: $("[id$='gistoken']").val()
		}); */
		IdentityManager.registerToken({
			server: SF_Label.urlPrefix,
			token: SF_Label.gisToken
		});
