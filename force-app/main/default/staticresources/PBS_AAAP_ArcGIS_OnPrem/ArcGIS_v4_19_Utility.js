...
console.log('Todd testing. ArcGIS v4.19 Utility JS file loading...');

//getLocatorUrlByState method
ArcGIS_v4_19.prototype.getLocatorUrlByState = function (state) {

console.log('Todd testing. ArcGIS v4.19 Utility JS file, getLocatorUrlByState() starting...  state: ', state);
...
console.log('Todd testing. ArcGIS v4.19 Utility JS file moveMarker() starting...   address: ', address);
...
console.log('Todd testing.  moveMarker, marker returned from createMarker()', marker);
...
console.log('Todd testing. ArcGIS v4.19 Utility JS file addMarker() starting...   address: ', address);
...
console.log('Todd testing. ArcGIS v4.19 Utility JS file suggest() starting...   location: ', location);
...
if (location.singleLineAddress && location.singleLineAddress.length > 0) {
    ...
    console.log('Todd testing. About to perform Promise() for address lookup minChars 4 and maxSuggests 10 for address length: ', location.singleLineAddress.length);
...
console.log('Todd testing. ArcGIS v4.19 Utility JS file search() starting...    location: ', JSON.stringify(location));
...
ArcGIS_v4_19.prototype.setView = function (view) {
    //console.log('setView function');
    this.map.setBasemap(view);
};

//loadAllLayers method. Load all the map layers.  This creates the layers.  It doesn't add them to the map. This.addlayer was commented out in June 2021
...
//loadCongressionalDistrictLayer method. Load the Congressional District Layer. Layers are not being loaded as of 6.21, once they are added this requires refactoring.
...
//loadSeismicLayer method, load the seismic layer. Layers are not being loaded as of 6.21, once they are added this requires refactoring
...
//loadFloodZoneLayer method, Load the Flood Zone Layer. Layers are not being loaded as of 6.21, once they are added this requires refactoring
ArcGIS_v4_19.prototype.loadFloodZoneLayer = function () {
    let container = $('[id$="map_canvas"]');//WIP needs change
...
//loadTransportationLayer method. Layers are not being loaded as of 6.21, once they are added this requires refactoring.
...
//loadCentralBusinessDistrictLayer method, Load the Central Business District layer. Layers are not being loaded as of 6.21, once they are added this requires refactoring.
